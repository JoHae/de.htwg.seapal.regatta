 ...
 * <ul>
 *   <li>{@link de.htwg.seapal.components.component.impl.MethodImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.htwg.seapal.components.component.impl.MethodImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link de.htwg.seapal.components.component.impl.MethodImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodImpl extends MinimalEObjectImpl.Container implements Method
{
  ...
  public EList<Property> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<Property>(Property.class, this, ComponentPackage.METHOD__PARAMETERS);
    }
    return parameters;
  }
  ...
  public Type getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentPackage.METHOD__TYPE, oldType, type));
      }
    }
    return type;
  }
